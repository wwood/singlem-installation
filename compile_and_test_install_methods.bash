...
bash -c 'singularity pull docker://wwood/singlem:$SINGLEM_VERSION && singularity run -B `pwd`:`pwd` singlem_$SINGLEM_VERSION.sif pipe --sequences `pwd`/test.fna --otu-table /dev/stdout' &> apptainer.build.log
